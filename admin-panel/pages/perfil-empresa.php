...
<head>
    ...
    <title>QuickHire - Administrar Empresa</title>
    <link rel="icon" href="/quickhire/assets/img/iconos/logo.png" type="image/png">
    <link rel="stylesheet" href="/quickhire/assets/css/empresa/empresas-perfil.css">
    ...
    <script src="../js/empresas-perfil.js"></script>
</head>
<body>
    <div id="container">
